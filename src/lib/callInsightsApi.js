...
/**
 * Nog niet beoordeelde suggesties, nieuwste gesprek eerst. MVP: Call
 * Insights is admin-only en toont de gekozen actieve consultant (zie
 * fetchActieveConsultant hieronder), niet per se de ingelogde admin zelf —
 * vandaar het expliciete filter i.p.v. vertrouwen op impliciete RLS-
 * eigenaarschap.
 */
