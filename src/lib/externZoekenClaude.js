...
- Score 70 of hoger en geen knock-out: klik ECHT op "Opslaan in pipeline" bij die kandidaat (fase "Niet benaderd") en controleer dat de knop verandert (de kandidaat is dan opgeslagen). Meld "in_pipeline": true ALLEEN als dat gelukt is; lukt opslaan niet, meld dan "in_pipeline": false en zet de reden in de onderbouwing.
...
STAP 6 — Afronden
Open aan het eind (ook als je moest stoppen) in het project de pagina "Pipeline" (linkermenu) en lees het getal bij "Alle kandidaten" af: dat is "pipeline_teller" (let op: het getal naast "Pipeline" in het linkermenu zelf is NIET het totaal). Open daarna opnieuw https://claude.ai/settings/usage en doe de laatste melding met "status": "klaar" (of "fout" met de reden in "voortgang"), "pipeline_teller": 162 en:
